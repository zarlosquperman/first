...
# --- 1. 페이지 기본 설정 ---
st.set_page_config(
    page_title="2-9반 연습 페이지",
    page_icon="🔮",
    layout="wide"
)

# --- 2. 페이지 타이틀 ---
st.title("백서현 선생님은 정말 친절하신 분이죠!!!! 🔮")
st.subheader("9반 조정우 허겸 허종훈 기타 허허허허허허")
st.subheader("오늘 밥은 무엇일까요? 선생님 어제 저녁은 칼국수!!")
st.markdown("---") # 구분선
...
with col2:
    st.write("유튜브 동영상 예제")
    st.video("https://www.youtube.com/watch?v=1NeLQ-Wl5QU&list=RD1NeLQ-Wl5QU&start_radio=1")
